...
public class MiniRocket : MonoBehaviour {
    ...
    private void Awake()
    {
        ...
        bulletLifeSpan = tankWeapon.bulletLifeSpan / 2;
        ...
        m_Rb.AddRelativeForce(Vector2.right * speed / 6);
    }
    ...
    private void Update()
    {
        // move side to side here
        m_Rb.AddRelativeForce(new Vector2(0, Random.Range(-0.1f, 0.1f)));
